        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: center">
                    <strong>Factory Outward Management</strong></td>
                            ...
                            <asp:GridView ID="grdFactoryOutward"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="DCNo" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLot" runat="server" Text='<%# Bind("DCNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <%--CompanyExecutive--%>
                                    <asp:TemplateField HeaderText="Company Executive" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
